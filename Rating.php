...
class Rating{
    ...
    public $user  = 'root';
    private $password   = "";
    private $database  = "nerdygadgets";
    private $itemUsersTable = 'item_users';
    private $itemTable = 'stockitems';
    ...
    public function getItemRating($itemId){
        $sqlQuery = "
			SELECT r.ratingId, r.itemId, r.userId, u.LogonName, r.ratingNumber, r.title, r.comments, r.created, r.modified
